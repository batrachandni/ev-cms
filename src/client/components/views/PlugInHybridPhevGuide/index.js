...
class PlugInHybridPhevGuide extends Component {
  constructor(props) {
    super(props);
    this.state ={
...
async componentDidMount(){
  ...
  const pageidofterms = this.props.pagesid.pages["plug-in-hybrid-phev-guide"].id;
...
handleFile = async(file) =>{
 ...
 render() {
    ...
    let headerTitle = "plug-in-hybrid-phev-guide"
