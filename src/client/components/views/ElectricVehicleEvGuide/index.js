...
class ElectricVehicleEvGuide extends Component {
  constructor(props) {
    super(props);
    this.state ={
...
async componentDidMount(){
  ...
  const pageidofterms = this.props.pagesid.pages["electric-vehicle-ev-guide"].id;
...
let  headerTitle = "electric-vehicle-ev-guide" 
